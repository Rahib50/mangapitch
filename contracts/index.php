...
if ($role === 'Admin' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($contractID && in_array($newStatus, $validStatuses, true)) {
        $pdo->prepare("UPDATE Contracts SET ProductStatus = ? WHERE ContractID = ?")
                ...
                <tr>
                    ...
                    <td>
                        <div class="status-track">
                            ...
                            ?>
                                <span class="status-step <?= $cls ?>"><?= htmlspecialchars($stage) ?></span>
                        ...
                        <td>
                            <?php if ($nextStatus): ?>
                                <form method="POST" style="display:inline">
                                    ...
                                    <button type="submit" class="btn btn-sm">→ <?= htmlspecialchars($nextStatus) ?></button>
                                </form>
                            <?php else: ?>
