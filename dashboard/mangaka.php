...
<main class="container">
    ...
    <div class="analytics-summary">
        ...
        <div class="stat">
            <span class="stat-value"><?= array_sum(array_column($mangas, 'BidCount')) ?></span>
    ...
    <div class="section-header">
        <h3>Your Manga</h3>
        <a href="<?= BASE ?>/manga/upload.php" class="btn btn-sm">+ Upload New</a>
    </div>

    <?php if (empty($mangas)): ?>
        <p class="muted">No manga uploaded yet. <a href="<?= BASE ?>/manga/upload.php">Upload your first one.</a></p>
    <?php else: ?>
        <table class="data-table">
            ...
            <?php foreach ($mangas as $m): ?>
                <tr>
                    <td><a href="<?= BASE ?>/manga/view.php?id=<?= $m['MangaID'] ?>"><?= htmlspecialchars($m['Title']) ?></a></td>
                    ...
                    <td><?= $m['BidCount'] ?></td>
                    <td>
                        <a href="<?= BASE ?>/bids/index.php" class="btn btn-sm">View Bids</a>
                        <a href="<?= BASE ?>/messages/index.php" class="btn btn-sm btn-secondary">Messages</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
